<template>
  <ion-card  text-center padding :style="{ 'background-color': getBackColor()  }" style="height:150px;width:150px"  >
    <div>
...
export default {
  ...
  methods: {
    ...
    getNumber() {
      ...
      var config = {
        method: "get",
        url: "https://localhost:7026/api/Auth/get/%2Ftray%2F"+this.getPath()+"%2Fcount%3FworkspaceId%3D"+this.Wid+"%26widgetId%"+this.getId(),
        headers: {
      ...
      var config1 = {
        method: "get",
         url: "https://localhost:7026/api/Auth/get/%2F"+this.getSPath()+"%2Fd71ac14b1b2cd144b712102c0f4a6e59%2Fcount",
        headers: {
          "Content-Type": "application/json",
        },
      };
